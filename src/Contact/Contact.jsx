            ...
            <>
              <div className={styles.formContainer}>
                <div className={styles.formContact}>
                  ...
                  >
                    <span className={styles.contentName}> { !language ? null : language.value === "en" || language === "en" ? en.name : es.name} </span>
                  </label>
                </div>
              </div>
              <div className={styles.btnContainer}>
                <ButtonContinue theme={theme} onClick={firstContinue}>
                  <p className={styles.btn}>{ !language ? null : language.value === "en" || language === "en" ? en.continue : es.continue}</p>
                </ButtonContinue>
              </div>
            </>
          ) : page === "second" ? (
            <>
              <div className={styles.formContainer}>
                <div className={styles.formContact}>
                  ...
                  >
                    <span className={styles.contentName}> { !language ? null : language.value === "en" || language === "en" ? en.email : es.email} </span>
                  </label>
                </div>
              </div>
              <div className={styles.btnContainer}>
            ...
            <>
              <div className={styles.formContainer}>
                <div className={styles.formContact}>
                  ...
                  >
                    <span className={styles.contentName}> { !language ? null : language.value === "en" || language === "en" ? en.message : es.message} </span>
                  </label>
                </div>
              </div>
              <div className={styles.btnContainer}>
                <ButtonSubmit theme={theme} onClick={sendEmail}>
                  <p className={styles.btn}>{ !language ? null : language.value === "en" || language === "en" ? en.submit : es.submit}</p>
                </ButtonSubmit>
              </div>
              ...
              {showAlert === true ? (
                ...
                >
                  <div className={styles.secondFlexContainer}>
                    ...
                    >
                      { !language ? null : language.value === "en" || language === "en" ? en.alert_msg : es.alert_msg}
                    </span>
                    <div className={styles.flexRow}>
                      ...
                      >
                        <p className={styles.btnAlertText}>
                        { !language ? null : language.value === "en" || language === "en" ? en.send_another : es.send_another}
                          <i
